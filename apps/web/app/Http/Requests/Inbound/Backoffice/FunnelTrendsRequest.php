...
final class FunnelTrendsRequest extends FormRequest
{
    /**
    ...
    public function toQuery(DateRangeQueryResolver $resolver): GetFunnelTrendsQuery
    {
        $range = $resolver->resolve($this);

        return new GetFunnelTrendsQuery(
            dateFrom: $range?->fromInclusive(),
            dateTo: $range?->toExclusive()?->modify('-1 day'),
        );
    }
