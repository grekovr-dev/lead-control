...
final class ListVisitsRequest extends FormRequest
{
    ...
    public function toQuery(): ListVisitsQuery
    {
        return new ListVisitsQuery(
            visitorId: $this->stringFilter('visitorId'),
            firstAttributionSource: $this->stringFilter('firstAttributionSource'),
            firstAttributionMedium: $this->stringFilter('firstAttributionMedium'),
    ...
    public function paginationQuery(): array
    {
        ...
        if ($filters['firstAttributionSource'] !== null) {
            $query['firstAttributionSource'] = $filters['firstAttributionSource'];
        }

        if ($filters['firstAttributionMedium'] !== null) {
