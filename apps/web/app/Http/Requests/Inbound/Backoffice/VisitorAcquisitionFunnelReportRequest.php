...
final class VisitorAcquisitionFunnelReportRequest extends FormRequest
{
    /**
    ...
    public function toQuery(DateRangeQueryResolver $resolver): GetVisitorAcquisitionFunnelReportQuery
    {
        return new GetVisitorAcquisitionFunnelReportQuery(
            firstVisitPeriod: $resolver->resolve($this),
        );
    }
