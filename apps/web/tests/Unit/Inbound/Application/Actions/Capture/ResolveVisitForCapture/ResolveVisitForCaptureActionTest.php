...
namespace Tests\Unit\Inbound\Application\Actions\Capture\ResolveVisitForCapture;
...
final class ResolveVisitForCaptureActionTest extends TestCase
{
    public function test_it_continues_last_visit_when_session_continues(): void
    {
        ...
        $command = new ResolveVisitForCaptureCommand(
        ...
        $action = new ResolveVisitForCaptureAction(
            $visitRepository,
